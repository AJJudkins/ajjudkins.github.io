...
aboutMe.placesLived.forEach((placeLived) => {
    let city = document.createElement('dt');
    city.textContent = placeLived.place;
    let lengthLived = document.createElement('dd');
    lengthLived.textContent = placeLived.length;
    document.getElementById('places-lived').appendChild(city);
    document.getElementById('places-lived').appendChild(lengthLived);
});